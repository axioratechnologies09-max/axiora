...
const ScrollStack = ({
  ...
  // Cached layout offset coordinates to prevent layout thrashing/feedback-loops
  ...
  // Recalculates card coordinates without transforms to get their true natural layout offsets
  const measureOffsets = useCallback(() => {
    if (!cardsRef.current.length) return;

    const originalTransforms = cardsRef.current.map(card => card.style.transform);
    
    // Temporarily reset transforms so getBoundingClientRect/offsetTop measures natural positions
